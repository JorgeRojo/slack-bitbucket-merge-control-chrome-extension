...
describe('Options Page', () => {
  ...
  test('should initialize DOM event listeners on DOMContentLoaded', async () => {
    ...
    const domContentLoadedHandler = document.addEventListener.mock.calls[0][1];
  ...
  test('should save options when save button is clicked with valid inputs', async () => {
    ...
    const saveClickHandler = mockElements.save.addEventListener.mock.calls[0][1];
    ...
    expect(mockElements.status.textContent).toBe('Options saved.');
